...
const AnalysisDashboard = ({ reports, isVisible }) => {
    ...
    >
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold" style={{ color: COLORS.teal }}>
                  {statistics.totalReports}
                </h3>
              </div>
              <ActivityIcon className="w-8 h-8" style={{ color: COLORS.turquoise }} />
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <UsersIcon className="w-8 h-8" style={{ color: COLORS.turquoise }} />
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <BarChart2Icon className="w-8 h-8" style={{ color: COLORS.turquoise }} />
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Total Support (ETH)</p>
                <h3 className="text-2xl font-bold" style={{ color: COLORS.teal }}>
                  {formatNumber(statistics.totalSupport)}
                </h3>
              </div>
              <MapIcon className="w-8 h-8" style={{ color: COLORS.turquoise }} />
            </div>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="mb-6 rounded-lg overflow-hidden shadow-sm border border-gray-100"
          style={{ height: '400px' }}
        >
            ...
            >
              ...
              {locations.map((location) => (
                ...
                >
                  <Popup>
                    <div className="p-2">
                      <h3 className="font-bold mb-1">Case #{location.id}</h3>
                      ...
                      <p className="text-xs mt-1" style={{ 
                        ...
                        {location.verified ? 'Verified' : 'Pending Review'}
                      </p>
                      {location.timestamp && (
        ...
        <motion.div
          ...
          className="bg-white rounded-lg p-4 shadow-sm border border-gray-100"
        >
          <h3 className="text-lg font-bold mb-4" style={{ color: COLORS.darkTeal }}>
          ...
          {trendsData.length === 0 && (
            <p className="text-center text-gray-500 mt-4">
              No report data available for trends visualization
            </p>
          )}
        </motion.div>
      </div>
